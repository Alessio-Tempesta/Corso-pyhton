...
# Aggiungere un libro alla biblioteca se non è prensente

# def aggiungi_libro(biblioteca, titolo):
#     if titolo in biblioteca:
#         print(f"il libro '{titolo}' è già presente nella biblioteca. ")
#         # indicare che il librou è disponibile
#     else:
#         biblioteca[titolo] = False #ilo libor è disponibile
#         print(f"il libro '{titolo}' è stato aggiunto alla biblioteca")

#     return biblioteca

# # eliminaimo un libro dalla biblioteca se è presente
# def elimina_libro(biblioteca, titolo):

#     if titolo in biblioteca:
#         biblioteca.remove(titolo)
#         print(f"il libro '{titolo} è stato eliminato dalla biblioteca.")
#     else:
#         print(f"il libro '{titolo}' non è presente nella biblioteca" )
#         return biblioteca
